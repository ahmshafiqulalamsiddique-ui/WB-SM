...
export default function ApprovePage() {
  ...
  const loadItems = async () => {
    setLoading(true);
    try {
      console.log('🔍 Approve page calling API: /api/list/');
  ...
  const decide = async (id: string, decision: "approved" | "rejected") => {
    console.log('🔄 Approve/Reject button clicked:', { id, decision });
    ...
    try {
      console.log('📤 Sending approve/reject request:', { id, decision, note });
